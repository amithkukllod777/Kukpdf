...
const en: Dict = {
  ...
  'home.noRecent': 'No documents yet',
  'home.noRecentHint': 'Scan a document or import a PDF — it’ll show up here.',
  'home.startScan': 'Start scanning',
  ...
  'files.emptyHint': 'Scan a document or import a PDF to get started.',
...
const hi: Dict = {
  ...
  'home.noRecent': 'अभी कोई दस्तावेज़ नहीं',
  'home.noRecentHint': 'दस्तावेज़ स्कैन करें या PDF इम्पोर्ट करें — यहाँ दिखेगा।',
  ...
  'files.emptyHint': 'शुरू करने के लिए दस्तावेज़ स्कैन करें या PDF इम्पोर्ट करें।',
